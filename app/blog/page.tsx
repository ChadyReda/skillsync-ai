...
export const metadata: Metadata = {
  ...
  description:
    "Career insights, interview tips, and AI-powered job search strategies from SkillSync.",
  openGraph: {
    title: "Blog — SkillSync",
    description:
      "Career insights, interview tips, and AI-powered job search strategies.",
  },
};
      ...
      <main className="mx-auto max-w-4xl space-y-10 px-4 py-12">
        ...
        <div>
          ...
          <p className="mt-2 text-base text-zinc-400">
            Strategies, insights, and guidance to accelerate your career in the
            AI era.
          </p>
        </div>
        ...
        {posts.length === 0 ? (
          <div className="flex flex-col items-center rounded-2xl border border-dashed border-zinc-800/60 py-24 text-center">
            ...
            <p className="mt-1 text-sm text-zinc-600">
              Check back soon for career insights.
            </p>
          </div>
        ) : (
            ...
            {posts.map((post, i) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  <h2
                    className={[
                      "font-bold text-white transition-colors group-hover:text-zinc-100",
